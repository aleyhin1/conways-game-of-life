...
public class GridSpawner : MonoBehaviour
{
    ...
    [SerializeField] private ComputeShader _spawnerCompute;
    ...
    private void OnEnable()
    {
        ...
        _spawnerCompute.SetVector(_resolutionID, new Vector4(_resolution.x, _resolution.y, 0, 0));
        _spawnerCompute.SetBuffer(0, _gridID, _gridBuffer);
    ...
    private void Start()
    {
        ...
        _spawnerCompute.Dispatch(0, groupX, groupY, 1);
    }
